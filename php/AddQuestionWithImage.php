...
<body>
  ...
  <section class="main" id="s1">
    <div id="response">-->
      ...
      $galdera = trim(preg_replace('/\r+/', ' ', $_POST['galdera']));
      $e_zuzena = trim(preg_replace('/\r+/', ' ', $_POST['e_zuzena']));
      $e_okerra1 = trim(preg_replace('/\r+/', ' ', $_POST['e_okerra1']));
      $e_okerra2 = trim(preg_replace('/\r+/', ' ', $_POST['e_okerra2']));
      $e_okerra3 = trim(preg_replace('/\r+/', ' ', $_POST['e_okerra3']));
